    ...
    return proxyToBackend({
        ...
        buildPayload: (body) => ({
            ...
            request_payload: {
                ...
                requires_registrant_authentication: body.requires_registrant_authentication ?? false,
                registrant_authentication_validity_days: body.registrant_authentication_validity_days ?? 730,
                registrant_re_auth_warning_days_before: body.registrant_re_auth_warning_days_before ?? 30,
