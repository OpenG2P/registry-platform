      ...
      {validationErrors.length > 0 && (
        <div
          style={{
            ...
            padding: '10px 12px',
            borderRadius: '8px',
            background: 'var(--owt-color-error-light)',
            ...
            return (
              <div
                ...
                style={{
                  ...
                  textAlign: 'right',
                  color: isHighlighted ? 'var(--owt-color-error)' : 'var(--owt-color-text-muted)',
                  fontWeight: isHighlighted ? 700 : 400,
                  background: isHighlighted ? 'var(--owt-color-error-light)' : 'transparent',
                  borderRadius: '4px',
                }}
              >
                {lineNumber}
