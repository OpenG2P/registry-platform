    ...
    return (
        <div className="rounded-[10px] space-y-4 animate-pulse">
            <div className="flex justify-between bg-primary-first/40 px-6 py-4.5 rounded-[10px] items-center">
                ...
                <div className="h-8 w-20 bg-neutral-first/20 rounded-[10px]" />
            </div>
    ...
    return (
        <div className="bg-secondary-second/60 rounded-[10px] p-6 space-y-3 animate-pulse">
            ...
            <div>
                ...
                <div className="h-4 w-[85%] bg-secondary-first rounded-[10px] mt-2" />
            </div>

            <div className="flex items-center gap-6 pt-2">
                {[1, 2].map((_, i) => (
                    <div key={i} className="flex items-center gap-2">
                        <div className="w-6 h-6 border border-secondary-first rounded-[10px] bg-neutral-second" />
                        <div className="h-4 w-12.5 bg-secondary-first rounded-[10px]" />
                    </div>
                ))}
            </div>
        </div>
