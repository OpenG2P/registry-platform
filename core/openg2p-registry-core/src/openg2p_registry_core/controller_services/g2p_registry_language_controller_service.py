...
class G2PRegistryLanguageControllerService(BaseService):
    ...
    async def update_language(self, update_request: UpdateLanguageRequest) -> LanguageOperationData:
    ...
    async def remove_language(self, remove_request: RemoveLanguageRequest) -> LanguageOperationData:
        ...
        g2p_register_service = G2PRegisterService.get_component()
        language_operation_data: LanguageOperationData = await g2p_register_service.remove_language(remove_language_request_payload.language_id)
        return language_operation_data
